            ...
            <div class="Mainsearch">
                <div class="center-block" id="abstract">
                    ...
                    <div class="form-group" id="searchKey">
											<input type="text" class="form-control" name="_keyword" placeholder="Keywords (optional)" />
                    </div>
                        ...
                        <div class="modal-body">
                            <form action="../UserLogin/UserLoginDB.php" method="GET" class="form col-md-12 center-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <span id="forgetpass"><a href="../FindPassword/FindPassword.php"><h4>Forgot password</h4></a></span>
